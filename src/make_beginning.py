...
for i in range(1, 200):
    ...
    file.write(
        "LernOS ist ein Lernsystem, das auf dem Konzept des lebenslangen Lernens basiert.\n"
    )
    file.write(
        "Es fördert die Selbstorganisation und die individuelle Gestaltung des Lernprozesses.\n"
    )
    file.close()
    os.chdir("./..")
